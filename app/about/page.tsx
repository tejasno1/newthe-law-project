...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-white dark:bg-gray-900">
      ...
      {/* ── Hero ── */}
      <section className="bg-gray-50 dark:bg-gray-800 pt-28 sm:pt-24 pb-10 sm:pb-16 border-b border-gray-100 dark:border-gray-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <motion.h1 {...fadeUp(0.08)} className="text-2xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 leading-tight">
            Legal education,<br />
            <span className="text-gradient">reimagined.</span>
          </motion.h1>
          <motion.p {...fadeUp(0.15)} className="text-gray-500 text-sm sm:text-lg leading-relaxed max-w-2xl mx-auto">
            The Law Project was founded with a simple yet powerful belief:
          </motion.p>
          <motion.blockquote
            {...fadeUp(0.22)}
            className="mt-4 sm:mt-6 text-sm sm:text-xl font-semibold text-gray-800 dark:text-gray-200 max-w-2xl mx-auto leading-relaxed border-l-4 border-primary-600 pl-4 sm:pl-6 text-left"
          >
      ...
      <section className="py-10 sm:py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div {...fadeUp(0)} className="prose prose-gray max-w-none">
            <motion.p {...fadeUp(0)} className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm sm:text-base mb-4 sm:mb-6">
            ...
            <motion.p {...fadeUp(0.05)} className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm sm:text-base mb-4 sm:mb-6">
            ...
            <motion.p {...fadeUp(0.08)} className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm sm:text-base mb-6 sm:mb-10">
          ...
          <motion.div
            {...fadeUp(0.1)}
            className="bg-primary-600 rounded-2xl p-5 sm:p-10 text-white mb-6 sm:mb-10"
          >
            <Quote className="w-6 h-6 sm:w-8 sm:h-8 text-primary-300 mb-3 sm:mb-4" />
          ...
          <motion.div {...fadeUp(0)} className="space-y-4 sm:space-y-6 mb-6 sm:mb-10">
            <motion.div {...fadeUp(0.05)} className="bg-gray-50 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-5 sm:p-7">
              <h3 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white mb-2 sm:mb-3">Because learning is not one-size-fits-all.</h3>
            ...
            <motion.p {...fadeUp(0.08)} className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm sm:text-base">
            ...
            <motion.p {...fadeUp(0.1)} className="text-gray-600 dark:text-gray-400 leading-relaxed text-sm sm:text-base">
          ...
          <motion.div
            {...fadeUp(0.12)}
            className="text-center py-7 sm:py-10 border-y border-gray-100 dark:border-gray-700 mb-6 sm:mb-10"
          >
            <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm mb-2 sm:mb-3">At The Law Project, we do not simply prepare students for examinations.</p>
            <p className="text-2xl sm:text-4xl font-bold text-gray-900 dark:text-white">We build <span className="text-gradient">future lawyers.</span></p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-10 sm:py-20 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div {...fadeUp(0)} className="flex flex-col items-center mb-7 sm:mb-12">
            <span className="inline-flex items-center gap-2 text-xs font-medium bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-full px-4 py-2 shadow-sm text-gray-600 dark:text-gray-400">
          ...
          >
            <div className="grid lg:grid-cols-5">
              ...
              {/* Content */}
              <div className="lg:col-span-3 p-5 sm:p-10 lg:p-12">
                <div className="mb-4 sm:mb-6">
                  <h2 className="text-xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-1">Bhavtosh A.</h2>
                  <p className="text-primary-600 font-semibold text-xs sm:text-sm">Law Educator · Lead Mentor · Founder, The Law Project</p>
                </div>
                ...
                <blockquote className="border-l-2 border-primary-600 pl-4 mb-4 sm:mb-5">
                  <p className="italic text-sm sm:text-base text-gray-800 dark:text-gray-200 font-medium leading-relaxed">
      ...
      <section className="py-10 sm:py-20 bg-white dark:bg-gray-900">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            {...fadeUp(0)}
            className="bg-gradient-to-br from-primary-600 to-primary-800 rounded-3xl px-6 sm:px-14 py-10 sm:py-14 text-center"
          >
            <p className="text-primary-200 text-xs sm:text-sm font-medium uppercase tracking-widest mb-3 sm:mb-4">Our Promise</p>
            <h2 className="text-xl sm:text-4xl font-bold text-white mb-4 sm:mb-6 leading-snug">
