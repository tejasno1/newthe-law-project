...
export default function NewCoursePage() {
  const [error, formAction] = useFormState(createCourse, null);
    ...
    <div className="max-w-lg">
      ...
      <div className="flex items-center gap-3 mb-8">
        <div className="w-10 h-10 bg-[#4d65ff]/10 rounded-xl flex items-center justify-center">
          <BookOpen className="w-5 h-5 text-[#4d65ff]" />
        </div>
        <div>
        ...
        <form action={formAction} className="space-y-5">
          <div>
            ...
            <input
              ...
              placeholder="e.g. CLAT PG Complete Batch 2025"
          ...
          <div>
            ...
            {slug && (
              <p className="text-xs text-gray-400 mt-1">
                URL will be: <span className="font-mono">/course/{slugify(slug) || slug}</span>
              </p>
            )}
          </div>
